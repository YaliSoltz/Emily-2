...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      aria-label="WhatsApp"
      className="fixed bottom-11 start-6 z-40 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-200"
    >
